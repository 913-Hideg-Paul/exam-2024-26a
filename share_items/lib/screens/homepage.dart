...
import 'package:share_items/screens/analytics_section.dart';
import 'package:share_items/screens/team_member_section.dart';
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => TeamMembersSection()));
                },
                child: const Text('Team Members section')),
            ...
            ElevatedButton(
                ...
                child: const Text('Analytics section')),
            online ? ItemNotification() : const Text(''),
          ],
        ),
      ),
